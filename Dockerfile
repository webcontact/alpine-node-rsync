...
# ENV VERSION=v11.13.0 NPM_VERSION=6 YARN_VERSION=latest
 ENV VERSION=v12.16.1 NPM_VERSION=6 YARN_VERSION=latest

# For base builds
# ENV CONFIG_FLAGS="--fully-static --without-npm" DEL_PKGS="libstdc++" RM_DIRS=/usr/include

RUN apk add --no-cache zlib-dev build-base nasm libtool automake autoconf pkgconfig openssh rsync git curl make gcc g++ python linux-headers binutils-gold gnupg libstdc++ && \
